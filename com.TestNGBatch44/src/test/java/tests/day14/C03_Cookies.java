...
public class C03_Cookies extends TestBase {
    ...
    public  void test01(){
     ...
     //  4- ismi i18n-prefs olan cookie degerinin "i18n-prefs=USD; expires=Sal, 31 Oca 2023 09:28:29 CET; path=/; domain=.amazon.com" oldugunu test edin
        Cookie cookieii8=driver.manage().getCookieNamed("i18n-prefs");
        System.out.println("cookiei18 degeri: "+cookieii8);
