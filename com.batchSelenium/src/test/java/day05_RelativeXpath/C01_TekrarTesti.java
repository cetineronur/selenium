...
public class C01_TekrarTesti {
    public static void main(String[] args) {
       ...
       //5- Sayfa basliginin “Spend less” ifadesi icerdigini test edin
        ...
        String titleSuche="Spend less";

        if(actualTitle.contains(titleSuche)){
       ...
       //10-Urun ucretinin 25$ oldugunu test edin
        ...
        String actualPreis=priceElement.getText();

        if(expectedFiyat.equals(actualPreis)){
            System.out.println("Preis Test PASS");
        }else{
